...
struct StorageInfo const StorageInfo  =  {
       ...
       "24c16_STM32L476",                            // Device Name + version number
    #else
...
// Specify Size and Address of Sectors (view example below)
   ...
   0x00000000, 0x00000000
    ...
    #elif defined(STM32L476xx)
       "24c512_STM32L476",                           // Device Name + version number
    #else
    #error "Please select first the target STM32F10X_MD or STM32L476xx!"
    #endif
   I2C_EEPROM,                   					 // Device Type
   0x00000000,                						 // Device Start Address
   0x10000,                 						 // Device Size in Bytes (65kBytes)
   0x0000080,                 						 // Programming Page Size 128Bytes
   0xFF,                       						 // Initial Content of Erased Memory
// Specify Size and Address of Sectors (view example below)
   0x00000200, 0x00000080,     				         // Sector Num : 512 ,Sector Size: 128Bytes 
   0x00000000, 0x00000000
};
#endif
